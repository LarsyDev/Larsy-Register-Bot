...
user.roles.add(Roles.GirlRole1) // Kız Rolunu Verir
user.roles.add(Roles.GirlRole1) // Kız Rolunu Verir
user.roles.add(Roles.GirlRole2) // Kız Rolunu Verir
user.roles.add(Roles.GirlRole2) // Kız Rolunu Verir
user.roles.add(Roles.GirlRole3) // Kız Rolunu Verir
user.roles.add(Roles.GirlRole3) // Kız Rolunu Verir
...
user.roles.remove(Roles.BoyRole1) // Erkek Rolunu Alır
user.roles.remove(Roles.BoyRole2) // Erkek Rolunu Alır
user.roles.remove(Roles.BoyRole3) // Erkek Rolunu Alır
user.roles.remove(Roles.BoyRole1) // Erkek Rolunu Alır
user.roles.remove(Roles.BoyRole2) // Erkek Rolunu Alır
user.roles.remove(Roles.BoyRole3) // Erkek Rolunu Alır  
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ["kadın", "k", "woman", "girl", "kız", "kiz"],
    permLevel: 0
};
